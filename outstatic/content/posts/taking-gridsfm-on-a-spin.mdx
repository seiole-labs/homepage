...
author:
  name: Ninad Sonawane
  picture: /images/416896f9-a84e-4828-84ba-5e429d85de90-EzMz.png
...
3. Networks Tested
4. Prediction Error Against AC-OPF
5. KCL and Thermal Violations
   - Active-Power KCL Violation & Reactive-Power KCL Violation
6. What the Feasibility Head Tells Us
7. Latency and Solver Iterations
8. Toward a Hybrid Solver
9. Takeaways
...
![](/images/001-networks-tested-EyND.svg)
...
![](/images/002-prediction-errors-IwNj.svg)
...
![](/images/003-active-kcl-violations-U5OD.svg)

### **Reactive-Power KCL Violation**

![](/images/004-reactive-kcl-violations-U4MT.svg)
...
![](/images/005-feasibility-output-k3MT.svg)
...
![](/images/006-latency-and-iterations-AxNz.svg)
